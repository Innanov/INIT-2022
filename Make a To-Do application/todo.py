...
def add_task():
    ...
    if task != "":
        ...
        tkinter.messagebox.showwarning(title="Warning!", message="You must write one.")
...
def delete_task():
    try:
        ...
        tkinter.messagebox.showwarning(title="Warning!", message="You must choose a one.")
...
def load_tasks():
    try:
        ...
        tkinter.messagebox.showwarning(title="Warning!", message="Doesn't exist.dat.")
